class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field solr_name("creator", :facetable), label: "Author", limit: 15
    config.add_facet_field solr_name("group", :facetable), label: "Organization", limit: 15
    config.add_facet_field solr_name("university", :facetable), label: "University", limit: 15
    config.add_facet_field solr_name("discipline", :facetable), label: "Discipline", limit: 15
    ...
    config.add_index_field solr_name("group", :stored_searchable), label: 'Organization', helper_method: :iconify_auto_link
    config.add_index_field solr_name("about", :stored_searchable), label: "About Me", itemprop: 'description', helper_method: :iconify_auto_link
    ...
    config.add_show_field solr_name("office", :stored_searchable)
    config.add_show_field solr_name("major_tags", :stored_searchable)
    config.add_show_field solr_name("minor_tags", :stored_searchable)
    config.add_show_field solr_name("history_tags", :stored_searchable)
    config.add_show_field solr_name("geo_tags", :stored_searchable)
    config.add_show_field solr_name("other_tags", :stored_searchable)
    config.add_show_field solr_name("about", :stored_searchable)
